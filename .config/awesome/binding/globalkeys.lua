...
function _M.get()
  local globalkeys = gears.table.join(
    ...
    {description = "Screen Brightness Down", group = "brightness"}),
    awful.key({  }, "XF86MonBrightnessUp", function () awful.spawn("xbacklight -inc 5")                end,
    {description = "Screen Brightness Up", group = "brightness"}),
    ...
    awful.key({  }, "XF86XF86AudioMute", function () awful.spawn("pactl set-sink-mute @DEFAULT_SINK@ toggle")                end,
    ...
    {description = "Start Audio Playback", group = "Audio"}),
    awful.key({  }, "XF86AudioStop", function () awful.spawn("playerctl pause")                end,
    {description = "Stop Audio Playback", group = "Audio"}),
    awful.key({  }, "XF86AudioNext", function () awful.spawn("playerctl next")                end,
    {description = "Next Audio Track", group = "Audio"}),
    awful.key({  }, "XF86AudioPrev", function () awful.spawn("playerctl previous")                end,
    {description = "Previous Audio Track", group = "Audio"}),
